    ...
    return (
        <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length < 5 || note.edescription.length < 5} type="button" className="btn btn-primary" onClick={handleCreateNote}>Update Query</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row my-3">
                <h2 className='title'>Your Quries</h2>
                <div className="container mx-1">
                    {notes.length === 0 && <p className='bg-dark text-white rounded ps-3 py-3'>No notes to display</p>}
